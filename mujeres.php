...
$stmt = $conn->prepare($sqldatosmujer);
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                ...
                                <!-- Product price-->
                                <h3 style="font-family: wallpoet;  color:blue;"><?= $producto['precio'] ?> €</h3>
                            </div>
                        </div>
                        <!-- Product actions-->
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div id="carouselExample<?= $producto['id'] ?>" class="carousel slide" data-bs-ride="carousel">
                                            ...
                                            <div class="modal-dialog"> <!-- Descripción larga -->
                                                <p><?=utf8_decode($producto['desc_larga'] )?></p>
                                            </div>
...
?>
<?php require_once("productosrand.php");
